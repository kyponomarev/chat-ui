...
export default class NewChatPage extends Block {
  constructor(props: NewPageProps = {
    ...
    form.onSubmit = NewChatPage._onFormSubmit.bind(this);
    App.eventBus.on(ChatsService.events.CHATS_CREATED, NewChatPage._onChatCreated.bind(this));
  }
  ...
  private static _onFormSubmit(formData: any) {
    App.eventBus.emit(ChatsService.events.CHATS_CREATE, formData.title);
  }

  private static _onChatCreated(chat: Chat) {
