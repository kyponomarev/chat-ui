...
export default class SignUpPage extends Block {
  constructor(props: Props = {
    ...
    form.onSubmit = SignUpPage._onFormSubmit.bind(this);
    App.eventBus.on(AuthService.events.AUTH_SIGNED_UP, SignUpPage._onAuthSuccess.bind(this));
    App.eventBus.on(AuthService.events.AUTH_SIGN_UP_FAILURE, SignUpPage._onAuthError.bind(this));
  }
